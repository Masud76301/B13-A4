...
const allInterviewCount = document.getElementById('interview-list');
const allRejectedCount = document.getElementById('rejected-list');

const totalJob = allJobCount.children.length - 1;
const totalInterview = allInterviewCount.children.length - 1;
const totalRejected = allRejectedCount.children.length - 1;
...
document.getElementById('interview-list')
    .addEventListener('click', function (event) {
        if (event.target.classList.contains('del-icon')) {
            ...
            const allJob = document.getElementById('interview-list');
            const totalJob = allJob.children.length - 2;
